...
class ML_Optimize_Pro_Admin {
	...
	public static function enqueue_assets( $hook ) {
		...
		// CSS inline critico - sobrepoe qualquer cache (browser / WP / plugin de cache)
		// e garante a identidade visual mesmo se o arquivo externo falhar.
		wp_add_inline_style( $global_handle, self::critical_inline_css() );
	}

	/**
	 * CSS inline critico - garante a identidade visual do admin mesmo se
	 * o arquivo externo nao for carregado (cache, permissao, etc).
	 * Especifidade alta: `.ml-optmize-pro-admin .classe`.
	 *
	 * @return string
	 */
	private static function critical_inline_css() {
		ob_start(); ?>
<style id="ml-optmize-pro-critical">
/* === ML Optimize Pro - CSS critico inline (sobrepoe cache) === */
:root {
	--mlopt-brand:       #0d7a3a;
	--mlopt-brand-dark:  #095c2a;
	--mlopt-brand-soft:  #e7f4ec;
	--mlopt-ink:         #102a43;
	--mlopt-muted:       #52606d;
	--mlopt-line:        #d9e2ec;
	--mlopt-line-strong: #b3c6cf;
	--mlopt-surface:     #fff;
	--mlopt-shadow:      0 10px 28px rgba(13, 122, 58, 0.08);
	--mlopt-shadow-soft: 0 8px 24px rgba(15, 23, 42, 0.05);
	--mlopt-radius:      18px;
}

/* === CONTAINER (fundo gradient ML) === */
.toplevel_page_ml-optmize-pro,
.ml-optmize-pro_page_ml-optmize-pro,
.toplevel_page_ml-optmize-pro #wpcontent,
.ml-optmize-pro_page_ml-optmize-pro #wpcontent,
...
.ml-optmize-pro-admin {
	...
	color: var(--mlopt-ink) !important;
}

/* === HERO (border-left verde ML) === */
.ml-optmize-pro-admin .mlopt-hero {
	...
	border: 1px solid var(--mlopt-line) !important;
	border-left: 6px solid var(--mlopt-brand) !important;
	border-radius: 20px !important;
	background: var(--mlopt-surface) !important;
	box-shadow: var(--mlopt-shadow-soft) !important;
}
.ml-optmize-pro-admin .mlopt-hero-brand {
	display: flex !important;
	align-items: flex-start !important;
	gap: 18px !important;
	min-width: 0 !important;
}
.ml-optmize-pro-admin .mlopt-hero-mark {
	display: grid !important;
	place-items: center !important;
	width: 88px !important;
	height: 88px !important;
	flex: 0 0 88px !important;
	border: 1px solid rgba(13, 122, 58, 0.22) !important;
	border-radius: 22px !important;
	background: radial-gradient(circle at 30% 30%, #fff 0%, #f3faf5 45%, #d4ecdd 100%) !important;
	color: var(--mlopt-brand) !important;
	box-shadow: 0 16px 30px rgba(13, 122, 58, 0.08) !important;
}
.ml-optmize-pro-admin .mlopt-hero-mark span {
	font-size: 24px !important;
	line-height: 1 !important;
	font-weight: 900 !important;
	letter-spacing: 0.08em !important;
}
.ml-optmize-pro-admin .mlopt-hero-copy h1 {
	margin: 0 0 10px !important;
	color: var(--mlopt-ink) !important;
	font-size: 30px !important;
	line-height: 1.15 !important;
}
.ml-optmize-pro-admin .mlopt-hero-intro {
	max-width: 820px !important;
	margin: 0 !important;
	color: var(--mlopt-muted) !important;
	font-size: 14px !important;
	line-height: 1.6 !important;
}
.ml-optmize-pro-admin .mlopt-hero-eyebrow {
...
.ml-optmize-pro-admin .mlopt-hero-meta {
	display: flex !important;
	flex-direction: column !important;
	align-items: flex-end !important;
	gap: 12px !important;
}
.ml-optmize-pro-admin .mlopt-version-badge {
	display: inline-flex !important;
	align-items: center !important;
	min-height: 34px !important;
	padding: 0 12px !important;
	border-radius: 999px !important;
	background: var(--mlopt-brand-soft) !important;
	color: var(--mlopt-brand) !important;
	font-size: 14px !important;
	font-weight: 800 !important;
}
...
/* === TABS (pill shape) === */
.ml-optmize-pro-admin .mlopt-tabs {
	display: flex !important;
	...
	border: 1px solid var(--mlopt-line) !important;
	border-radius: var(--mlopt-radius) !important;
	background: var(--mlopt-surface) !important;
	box-shadow: var(--mlopt-shadow-soft) !important;
}
.ml-optmize-pro-admin .mlopt-tab {
	display: inline-flex !important;
	align-items: center !important;
	gap: 6px !important;
	min-height: 38px !important;
	padding: 0 16px !important;
	border: 1px solid var(--mlopt-line-strong) !important;
	border-radius: 999px !important;
	background: var(--mlopt-surface) !important;
	color: var(--mlopt-brand) !important;
...
.ml-optmize-pro-admin .mlopt-tab:hover {
	background: var(--mlopt-brand-soft) !important;
	color: var(--mlopt-brand) !important;
}
.ml-optmize-pro-admin .mlopt-tab.is-active {
	background: var(--mlopt-brand) !important;
	border-color: var(--mlopt-brand) !important;
	color: #fff !important;
}
.ml-optmize-pro-admin .mlopt-tab .dashicons {
...
/* === CARDS === */
.ml-optmize-pro-admin .mlopt-grid {
	display: grid !important;
	grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)) !important;
	gap: 18px !important;
}
.ml-optmize-pro-admin .mlopt-card {
	padding: 22px !important;
	border: 1px solid var(--mlopt-line) !important;
	border-radius: var(--mlopt-radius) !important;
	background: var(--mlopt-surface) !important;
	box-shadow: var(--mlopt-shadow) !important;
	transition: box-shadow 0.18s ease, transform 0.18s ease !important;
}
.ml-optmize-pro-admin .mlopt-card:hover {
	box-shadow: 0 14px 36px rgba(15, 23, 42, 0.10) !important;
	transform: translateY(-1px) !important;
}
.ml-optmize-pro-admin .mlopt-card h2 {
	margin: 0 0 8px !important;
	color: var(--mlopt-ink) !important;
	font-size: 20px !important;
	line-height: 1.3 !important;
}
.ml-optmize-pro-admin .mlopt-card .description {
	color: var(--mlopt-muted) !important;
	font-size: 13px !important;
...
/* === SCORE RING (160px) === */
.ml-optmize-pro-admin .mlopt-score-card {
	display: flex !important;
	align-items: center !important;
	justify-content: center !important;
	min-height: 240px !important;
}
.ml-optmize-pro-admin .mlopt-score {
	text-align: center !important;
}
.ml-optmize-pro-admin .mlopt-score-ring {
	position: relative !important;
	width: 160px !important;
	height: 160px !important;
	margin: 0 auto 14px !important;
}
.ml-optmize-pro-admin .mlopt-score-ring svg {
	width: 100% !important;
...
.ml-optmize-pro-admin .mlopt-score-ring circle {
	fill: none !important;
	stroke-width: 10 !important;
	stroke-linecap: round !important;
}
.ml-optmize-pro-admin .mlopt-ring-bg {
	stroke: var(--mlopt-line) !important;
}
.ml-optmize-pro-admin .mlopt-ring-fg {
	stroke: var(--mlopt-brand) !important;
	stroke-dasharray: 326.7 !important;
	stroke-dashoffset: calc(326.7 - (326.7 * var(--p, 0) / 100)) !important;
	transition: stroke-dashoffset 1.2s cubic-bezier(0.4, 0, 0.2, 1) !important;
}
.ml-optmize-pro-admin .mlopt-score-value {
...
.ml-optmize-pro-admin .mlopt-score-label {
	font-size: 13px !important;
	color: var(--mlopt-muted) !important;
}

/* === BUTTONS (pill, verdes) === */
.ml-optmize-pro-admin .button,
.ml-optmize-pro-admin .button-primary,
.ml-optmize-pro-admin .mlopt-btn,
.ml-optmize-pro-admin .mlopt-btn-save {
	display: inline-flex !important;
	align-items: center !important;
	justify-content: center !important;
	min-height: 42px !important;
	padding: 0 18px !important;
	border: 1px solid var(--mlopt-brand) !important;
	border-radius: 999px !important;
	background: var(--mlopt-brand) !important;
	color: #fff !important;
	font-weight: 800 !important;
...
.ml-optmize-pro-admin .button:hover,
.ml-optmize-pro-admin .button-primary:hover,
.ml-optmize-pro-admin .mlopt-btn:hover,
.ml-optmize-pro-admin .mlopt-btn-save:hover {
	background: var(--mlopt-brand-dark) !important;
	border-color: var(--mlopt-brand-dark) !important;
	color: #fff !important;
}
.ml-optmize-pro-admin .button:not(.button-primary),
.ml-optmize-pro-admin .button-secondary {
	background: var(--mlopt-surface) !important;
	color: var(--mlopt-brand) !important;
	border-color: var(--mlopt-line-strong) !important;
}
.ml-optmize-pro-admin .button:not(.button-primary):hover,
.ml-optmize-pro-admin .button-secondary:hover {
	background: var(--mlopt-brand-soft) !important;
	color: var(--mlopt-brand) !important;
	border-color: var(--mlopt-brand) !important;
}
